...
Route::get('/login/admin', function(){ return view('login.admin-login');})->middleware('admin_logged');
...
Route::get('/login/wisatawan', function(){ return view('login.wisatawan-login',); })->middleware('guest');
...
Route::get('/debug/login', function(){
    return view('login.wisatawan-login');
});